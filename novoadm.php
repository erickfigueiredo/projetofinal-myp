      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <?php
             	if (isset($_SESSION['sucesso_cadas'])) {
             		if($_SESSION['sucesso_cadas'] =='OK'){
            ?>
               <br><div id="suc" class="alert alert-success">
                   <i class="fas fa-check"></i>
                        Cadastro feito com sucesso!
			    </div>
            <?php
             			$_SESSION['sucesso_cadas']='NEUTRO';
             		}
             	}
            ?>
          ...
          <div class="container" style="margin-top: 6%">
		      <div class="card card-register mx-auto">
		        <div class="card-header cormyp" style="font-weight: bold">Novo Administrador</div>
		        <div class="card-body">
		          <form method="POST" action="cadasadm.php">
		            <div class="form-group">
		              <div class="form-row">
		                <div class="col-md-6">
		                  <div class="form-label-group">
		                    <input type="text" name="nick" id="inputNick" class="form-control" placeholder="Nome completo" required="required" autofocus="autofocus">
		            ...
		            <div class="form-group">
		              <div class="form-label-group">
		                <input type="email" name="emailCadas" id="inputEmail" class="form-control" placeholder="Email" required="required" autofocus="autofocus">
		            ...
		            <div class="form-group">
		              <div class="form-row">
		                <div class="col-md-6">
		                  <div class="form-label-group">
		                    <input type="password" name="senhaCadas" id="inputPassword" class="form-control" placeholder="Senha" required="required" autofocus="autofocus">
		                    <label for="inputPassword">Senha</label>
		                  </div>
		                </div>
		                <div class="col-md-6">
		                  <div class="form-label-group">
		                    <input type="password" name="confsenhaCadas" id="confirmPassword" class="form-control" placeholder="Confirme a senha" required="required" autofocus="autofocus">
		            ...
		            <?php
		            	if (isset($_SESSION['errocadasuser'])) {
		            		if($_SESSION['errocadasuser']=='ERRO'){
		            ?>
		             <br><div id="errocadas" class="alert alert-danger">
		                 <i class="fas fa-exclamation-triangle"></i>
                                    Senhas não conferem.
			        </div>
		            <?php
		            			$_SESSION['errocadasuser']='OK';
		            		}
		            	}
		            ?>
		            <?php

		                if (isset($_SESSION['mesmo_email_cadas'])) {
		            		if($_SESSION['mesmo_email_cadas']=='ERRO'){
		            ?>
		             <br><div id="mesmo_email" class="alert alert-danger">
		                 <i class="fas fa-exclamation-triangle"></i>
                                   Esse email já está cadastrado.
			        </div>
		            <?php
		            			$_SESSION['mesmo_email_cadas']='OK';
		            		}
		            	}
		            ?>
